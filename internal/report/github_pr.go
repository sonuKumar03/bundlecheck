...
func ComparisonGitHubPR(w io.Writer, r *comparison.Result, budgetCheck budget.CheckResult, opts TextOptions) error {
	...
	sb.WriteString("<!-- bundleradar-comment -->\n")
	...
	titlePrefix := "## 📦 BundleRadar PR Report"
	if opts.Project != "" {
		titlePrefix = fmt.Sprintf("## 📦 BundleRadar PR Report (`%s`)", opts.Project)
	}
	fmt.Fprintf(&sb, "%s — %s\n\n", titlePrefix, badge)
	...
	sb.WriteString("<sub>Generated by <a href=\"https://github.com/sonuKumar03/bundleradar\">bundleradar</a></sub>\n")
